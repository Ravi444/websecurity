...
* @licence MIT
* !function(a,b){"function"==typeof define&&define.amd?define([],b):"object"==typeof exports?module.exports=b(require()):a.crs=b(a)}(this,function(){"use strict";var a="crs-country",b="Select country",c="Select State/Province",d=[

*/
!function(a,b){"function"==typeof define&&define.amd?define([],b):"object"==typeof exports?module.exports=b(require()):a.crs=b(a)}(this,function(){"use strict";var path = Granite.HTTP.getPath().split("/"); var locale = "en_us";if (path.length > 4)  locale = path[4]; Granite.I18n.setLocale(locale); var a="crs-country",b=Granite.I18n.get('Select country'),c=Granite.I18n.get('Select State/Province'),d=[
["United States","US","Alaska|Alabama|Arizona|Arkansas|California|Colorado|Connecticut|Delaware|District of Columbia|Florida|Georgia|Hawaii|Idaho|Illinois|Indiana|Iowa|Kansas|Kentucky|Louisiana|Maine|Maryland|Massachusetts|Michigan|Minnesota|Mississippi|Missouri|Montana|Nebraska|Nevada|New Hampshire|New Jersey|New Mexico|New York|North Carolina|North Dakota|Ohio|Oklahoma|Oregon|Pennsylvania|Rhode Island|South Carolina|South Dakota|Tennessee|Texas|Utah|Vermont|Virginia|Washington|West Virginia|Wisconsin|Wyoming|Armed Forces Africa|Armed Forces Americas|Armed Forces Canada|Armed Forces Europe|Armed Forces Middle East|Armed Forces Pacific|American Samoa|Guam|Marshall Islands|Northern Mariana Islands|Palau|Puerto Rico|Virgin Islands"],
...
["American Samoa","AS","Tutuila|Aunu'u|Ta'u|Ofu-Olosega|Rose Atoll|Swains Island"],
...
["Montenegro","ME","Andrijevica|Bar|Berane|Bijelo Polje|Budva|Cetinje|Danilovgrad|Herceg Novi|Kolašin|Kotor|Mojkovac|Nikšic|Plav|Plužine|Pljevlja|Podgorica|Golubovci|Tuzi|Rožaje|Šavnik|Tivat|Ulcinj|Žablja"],
...
["Palestinian Territory, Occupied","PS","Palestine"],
...
["Taiwan","TW","Chang-hua|Chi-lung|Chia-i|Chung-hsing-hsin-ts'un|Hsin-chu|Hua-lien|I-lan|Kao-hsiung|Miao-li|Nan-t'ou|P'eng-hu|P'ing--chung|T'ai-chung|T'ai-nan|T'ai-pei|T'ai-tung|T'ao-yuan|Yun-lin"],
...
["Zimbabwe","ZW","Bulawayo|Harare|ManicalandMashonaland Central|Mashonaland East|Mashonaland West|Masvingo|Matabeleland North|Matabeleland South|Midlands"]],e=function(){

CQ.form.CustomMultiField=CQ.Ext.extend(CQ.form.CompositeField,{fieldConfig:null,numberOfItems:null,customMultiFieldName:null,storeIndexPos:false,maxItems:55,constructor:function(b){var e=this;
...
b=CQ.Util.applyDefaults(b,{defaults:{xtype:"custommultifielditem",fieldConfig:b.fieldConfig,storeIndexPos:false,maxItems:55},items:[{xtype:"panel",border:false,bodyStyle:"padding:4px",items:a}]});
...
CQ.Ext.Msg.show({title:CQ.I18n.getMessage("Create New Item"),msg:d,buttons:CQ.Ext.Msg.OK})
...
CQ.Ext.reg("dynamicmultifield",CQ.form.CustomMultiField);
...
if(!b.fieldConfig.readOnly){a.push({xtype:"panel",border:false,items:{xtype:"button",cls:"cq-multifield-btn",text:"Del",handler:function(){var g=d.ownerCt;
...
CQ.Ext.reg("dynamicmultifielditem",CQ.form.CustomMultiField.Item);
